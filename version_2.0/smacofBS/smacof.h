...
void smacofMakeBasis(const int m, const int ninner, const int order,
                     ...
                     const int knots, double *vdhat, char *name, double *vknots,
                     double *vinner, double **mbasis);
...
void smacofPrintLowerTriangularMatrix(FILE *stream, const int n,
                                      const int width, const int precision,
                                      double **x);
void smacofPrintLowerTriangleFromVector(FILE *stream, const int n,
                                        const int width, const int precision,
                                        double *x);
...
void smacofReadParameterFile(FILE *stream, int *n, int *p, int *m, int *init,
                             ...
                             int *fepsi, int *cepsi, int *verbose, int *ditmax,
                             int *depsi, int *dverbose, int *jitmax, int *jepsi,
                             int *jverbose, int *transform, int *degree,
...
void smacofGuttmanTransformU(const int n, const int p, double *vdhat,
                             double *vdmat, double **mxold, double **mxnew);
double smacofStressU(const int m, double *vdhat, double *vdmat);
...
void smacofNormalizeConfigurationU(const int m, const int np, double *vdist, double *xvec);
