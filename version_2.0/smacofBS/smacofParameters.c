...
void smacofReadParameterFile(FILE *stream, int *n, int *p, int *init,
                             int *width, int *precision, int *relax, int *itmax,
                             int *haveweights, int *fepsi, int *cepsi,
                             int *verbose, int *ditmax, int *depsi,
                             int *dverbose, int *jitmax, int *jepsi,
                             int *jverbose, int *degree, int *ordinal,
                             int *haveknots, int *ninner, int *writefile,
                             int *labels, int *dohessian, int *dobmat,
...
void smacofWriteParameters(
    ...
    const int precision, const int relax, const int itmax,
    const int haveweights, const int fepsi, const int cepsi, const int verbose,
    const int ditmax, const int depsi, const int dverbose, const int jitmax,
    const int jepsi, const int jverbose, const int degree, const int ordinal,
    const int haveknots, const int ninner, const int writefile,
    const int labels, const int dohessian, const int dobmat, const int checkkt,
    const int anchor, const int origin) {
    fprintf(stream, "n %d\n", n);
    fprintf(stream, "p %d\n", p);
