...
```{r dcityresults, echo = FALSE}
source("results/hdcityResults.R")
```

```{r dcitykable, echo = FALSE}
x <- matrix(c(
...
```{r hdcitylinear, fig.align = "center", fig.cap = "dcity example, linear analysis", echo = FALSE}
par(mfrow = c(1,2))
smacofShepardPlot(hdcity010)
smacofShepardPlot(hdcity010o)
```
```{r hdcitycubic, fig.align = "center", fig.cap = "dcity example, cubic analysis", echo = FALSE}
par(mfrow = c(1,2))
smacofShepardPlot(hdcity030)
smacofShepardPlot(hdcity533)
```
```{r hdcityordinal, fig.align = "center", fig.cap = "dcity example, nonmetric analysis", echo = FALSE}
par(mfrow = c(1,2))
...
```{r hekmancubic, fig.align = "center", fig.cap = "Ekman example, cubic analysis", echo = FALSE}
par(mfrow = c(1,2))
smacofShepardPlot(hekman030)
smacofShepardPlot(hekman533)
```
```{r hekmanordinal, fig.align = "center", fig.cap = "Ekman example, nonmetric analysis", echo = FALSE}
par(mfrow = c(1,2))
